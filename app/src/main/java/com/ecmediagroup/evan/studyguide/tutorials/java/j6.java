...
public class j6 extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        wv.loadUrl("https://www.tutorialspoint.com/java/java_basic_operators.htm");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_favorite:
                ...
                startActivity(new Intent(j6.this, Note_drv.class));
