package com.example.evan.comp296.group_chat;
...
import com.example.evan.comp296.group_chat.callbacks.BasicCallback;
...
import com.example.evan.comp296.group_chat.adt.ChatMessage;
 ...
 *
 */
public class MainActivity_for_chat extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!mSharedPrefs.contains(Constants.CHAT_USERNAME)){
            Intent toLogin = new Intent(this, LoginActivity_for_chat.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_main_for_chat, menu);
        ...
        this.mPubNub.hereNow(this.channel, new Callback() {
            ...
            public void successCallback(String channel, Object response) {
                try {
                    ...
                    MainActivity_for_chat.this.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            if (mHereNow != null)
            ...
            public void successCallback(String channel, Object response) {
                ...
                try {
                    ...
                    MainActivity_for_chat.this.runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            if (!online)
                                Toast.makeText(MainActivity_for_chat.this, user + " is not online.", Toast.LENGTH_SHORT).show();
                            else
                                Toast.makeText(MainActivity_for_chat.this, user + " logged in since " + ChatAdapter.formatTimeStamp(loginTime), Toast.LENGTH_SHORT).show();
                    ...
                    try {
                        ...
                        MainActivity_for_chat.this.runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                if ((String.valueOf(occ) !=null)) {
                                    mHereNow.setTitle(String.valueOf(occ) + " Users Online");
                                }else{
                                    finish();
                                }
                            }
            ...
            public void successCallback(String channel, final Object message) {
                try {
                    ...
                    MainActivity_for_chat.this.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(MainActivity_for_chat.this,"RUNNIN", Toast.LENGTH_SHORT).show();
    ...
    public void signOut(){
        ...
        edit.apply();
        Intent intent = new Intent(this, LoginActivity_for_chat.class);
    ...
    private class RegisterTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            ...
            try {
                if (gcm == null) {
                    gcm = GoogleCloudMessaging.getInstance(MainActivity_for_chat.this);
                }
